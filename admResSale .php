...
<section class="sec1">
            <div class="container">
                <div class="row">
                    <h1 class="text-center">Residential's Resale page</h1>
                      <form>
...
<option value="<?php echo $row->id_res_a_s;  ?>"><?php  echo $row->name_res_a_s;  ?></option>
...
<?php endforeach;  ?>  
  ...
  let name_are = $("#new_nameArea").val();
            var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
                ...
                form_data.append('action' , 'admResSale');
 ...
 var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
    ...
    form_data.append('action' , 'admResSale_p_img');
...
function project_1(elm){
          ...
          let name = $(".pro1").val();
            var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
                ...
                form_data.append('action' , 'project_1_d_res_sale');
        ...
        function project_2(elm){
          ...
          let name = $(".pro2").val();
            var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
                ...
                form_data.append('pro_name' , name);
                form_data.append('desc' , dec);
                form_data.append('action' , 'project_2_d_res_sale');
        ...
        function project_3(elm){
          ...
          let name = $(".pro3").val();
            var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
                ...
                form_data.append('pro_name' , name);
                form_data.append('desc' , dec);
                form_data.append('action' , 'project_3_d_res_sale');
        ...
        function project_4(elm){
          ...
          let name = $(".pro4").val();
            var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
                ...
                form_data.append('pro_name' , name);
                form_data.append('desc' , dec);
                form_data.append('action' , 'project_4_d_res_sale');
...
$(document).ready(function(){
  ...
  $("#save").click(function(){
                ...
                form_data.append('action' , 'linkResSale');
