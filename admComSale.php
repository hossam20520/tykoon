...
<section class="sec1">
            <div class="container">
                <div class="row">
                    <h1 class="text-center">Commercial's Resale </h1>
                      <form>
...
<option value="<?php echo $row->id_com_a_s;  ?>"><?php  echo $row->name_com_a_s;  ?></option>
...
<?php endforeach;  ?>  
                    ...
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-default" id= "save" style="padding-left: 20px;padding-right:20px">Save</button> 
                    </div>
                </div>
            </div>
        </section>
        ...
        function update_area_img(elm){
            ...
            var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
                ...
                form_data.append('action' , 'admComSale');
 ...
 var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
    ...
    form_data.append('action' , 'admComSale_p_img');
...
function project_1(elm){
          ...
          let name = $(".pro1").val();
            var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
                ...
                form_data.append('action' , 'project_1_d_com_sale');
        ...
        function project_2(elm){
          ...
          let name = $(".pro2").val();
            var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
                ...
                form_data.append('pro_name' , name);
                form_data.append('desc' , dec);
                form_data.append('action' , 'project_2_d_com_sale');
        ...
        function project_3(elm){
          ...
          let name = $(".pro3").val();
            var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
                ...
                form_data.append('pro_name' , name);
                form_data.append('desc' , dec);
                form_data.append('action' , 'project_3_d_com_sale');
        ...
        function project_4(elm){
          ...
          let name = $(".pro4").val();
            var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
                ...
                form_data.append('pro_name' , name);
                form_data.append('desc' , dec);
                form_data.append('action' , 'project_4_d_com_sale');
...
$(document).ready(function(){
  ...
  $("#save").click(function(){
                ...
                form_data.append('action' , 'linkComSale');
