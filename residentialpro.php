...
?>
            ...
            <a href="https://tykooneg.com/listprojects/?ID_AREA=<?php echo $row->id_res_a;  ?>&&NAME=<?php echo $row->name_res_a;  ?>"><img  src="<?php  echo $row->img_res_a;  ?>" data-id="<?php echo $row->id_res_a;  ?>" id="imog"></a>
    ...
    color: #f1f1f1;
" data-id="<?php echo $row->id_res_a;  ?>"> Delete </button>
<button class="edit" style="
    border: none;
    margin-left: 20px;
    background-color: #3d56d2;
    color: #f1f1f1;
    "  data-idE="<?php echo $row->id_res_a;  ?>" data-name="<?php echo $row->name_res_a;  ?>" data-toggle="modal"   data-target="#myModal"  >EDIT</button>
