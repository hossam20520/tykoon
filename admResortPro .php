...
<section class="sec1">
            <div class="container">
                <div class="row">
                    <h1 class="text-center">Resort's projects </h1>
                      <form>
...
<option value="<?php echo $row->id_sort_a;  ?>"><?php  echo $row->name_sort_a;  ?></option>
...
<?php endforeach;  ?>  
  ...
  let name_are = $("#new_nameArea").val();
            var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
                ...
                form_data.append('action' , 'admSortPro');
 ...
 var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
    ...
    form_data.append('action' , 'admSortPro_p_img');
...
function project_1(elm){
          ...
          let name = $(".pro1").val();
            var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
                ...
                form_data.append('action' , 'project_1_d_sort');
        ...
        function project_2(elm){
          ...
          let name = $(".pro2").val();
            var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
                ...
                form_data.append('pro_name' , name);
                form_data.append('desc' , dec);
                form_data.append('action' , 'project_2_d_sort');
        ...
        function project_3(elm){
          ...
          let name = $(".pro3").val();
            var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
                ...
                form_data.append('pro_name' , name);
                form_data.append('desc' , dec);
                form_data.append('action' , 'project_3_d_sort');
        ...
        function project_4(elm){
          ...
          let name = $(".pro4").val();
            var ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>";  
                ...
                form_data.append('pro_name' , name);
                form_data.append('desc' , dec);
                form_data.append('action' , 'project_4_d_sort');
...
$(document).ready(function(){
  ...
  $("#save").click(function(){
                ...
                form_data.append('action' , 'linkSortPro');
